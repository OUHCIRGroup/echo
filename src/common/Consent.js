...
const ConsentForm = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <br />
      <p className="mb-4">
        <strong>What is the purpose of this research?</strong> The purpose of
        this research is to evaluate functional fixedness in Human-LLM
        Interaction.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        research, you will complete tasks involving interactions with ChatGPT or
        a search engine, answering questions, and providing feedback through
        surveys.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        <strong>What are the risks and/or benefits if I participate?</strong>{" "}
        There are no anticipated risks or direct benefits to you from
        participating in this study.
      </p>
      <p className="mb-4">
        <strong>Will I be compensated for participating?</strong> You will
        receive compensation for your participation as specified in the
