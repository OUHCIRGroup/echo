...
const ManageDemographySurvey = () => {
  ...
  const handleSave = async (items) => {
    ...
    try {
      ...
      setStatus({ type: "success", message: `Saved ${items.length} questions to admin/demographySurvey.` });
    } catch (err) {
      console.error(err);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Manage Demography Survey</h1>
          <p className="text-gray-600">Create and manage demographic survey questions</p>
        </div>
