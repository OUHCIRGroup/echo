...
const ManageExperienceSurvey = () => {
  ...
  const handleSave = async (items) => {
    ...
    try {
      ...
      setStatus({
        type: "success",
        message: `Saved ${items.length} questions to admin/experienceSurvey.`,
      });
    } catch (err) {
      console.error(err);
      setStatus({
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">
            Manage Experience Survey
          </h1>
          <p className="text-gray-600">
            Create, manage, and reorder session experience survey questions
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          ...
          <div className="mt-4 text-sm text-gray-600">
            {mode === "view" &&
              "View all current survey questions and their configuration."}
            {mode === "reorder" &&
