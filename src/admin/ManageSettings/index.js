...
//             Manage your API keys for OpenAI, Bing Search, and Brave Search
//             services.
//           </p>
//         </div>
...
//                 API keys are sensitive credentials. They are stored securely in
//                 Firebase but will be accessible to client code.
//               </p>
//             </div>
//           </div>
//         </div>
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your personal API keys for OpenAI, Bing Search, and Brave
            Search services.
          </p>
        </div>
