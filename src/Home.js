    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-2xl mx-auto px-4 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-xl font-bold text-gray-800">Research Study</h1>
            <p className="text-sm text-gray-500">
              Welcome, {authCtx.user?.email || "Participant"}
            </p>
          </div>
          <div className="flex gap-3">
            {authCtx.isAdmin && (
              <button
                onClick={() => navigate("/admin")}
                className="px-4 py-2 bg-indigo-100 text-indigo-700 rounded-lg hover:bg-indigo-200 transition-colors flex items-center gap-2 text-sm font-medium"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            >
              ...
              {firstTaskShort === "chat" ? "ChatGPT" : "Search Engine"}
            </div>
          </div>
